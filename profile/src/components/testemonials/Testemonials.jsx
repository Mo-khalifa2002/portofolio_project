        ...
        >
          <SwiperSlide>
            <div className="swiper-section">
              ...
              <h3 className="fw-bold text-center text-capitalize mt-5">moo</h3>
              <p className="fw-normal p-2 mt-4">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae
                voluptatibus quia quidem fugiat odit odio delectus alias
                pariatur? Tempora pariatur numquam ducimus rem, veritatis ipsam
                et quisquam provident culpa magni!
              </p>
              {/* <StarRating /> */}
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="swiper-section">
              ...
              <h3 className="fw-bold text-center text-capitalize mt-5">djfl-sdfs</h3>
              <p className="fw-normal p-2 mt-4">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae
                voluptatibus quia quidem fugiat odit odio delectus alias
                pariatur? Tempora pariatur numquam ducimus rem, veritatis ipsam
          ...
          <SwiperSlide>
            <div className="swiper-section">
              ...
              <h3 className="fw-bold text-center text-capitalize mt-5">sdf-dfs</h3>
              <p className="fw-normal p-2 mt-4">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae
                voluptatibus quia quidem fugiat odit odio delectus alias
                pariatur? Tempora pariatur numquam ducimus rem, veritatis ipsam
          ...
          <SwiperSlide>
            <div className="swiper-section">
              ...
              <h3 className="fw-bold text-center text-capitalize mt-5">sf-erw</h3>
              <p className="fw-normal p-2 mt-4">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae
                voluptatibus quia quidem fugiat odit odio delectus alias
                pariatur? Tempora pariatur numquam ducimus rem, veritatis ipsam
